export default function Dashboard() {
  ...
  var reports = 58;
  var customersActive = 40;
  var servicesAccomplished = 58;
  var customersTotal = 58;
  var servicesToday = 2;
      ...
      <div className="flex flex-row w-full gap-x-24 px-24">
        ...
        <div className="basis-1/3 w-full bg-white p-4 rounded-lg shadow-lg">
          ...
          <div className="flex flex-row items-center justify-center my-8">
            ...
            <p className="text-9xl font-bold text-dark-green-B">{reports}</p>
          </div>
        </div>
        ...
        <div className="basis-1/3 w-full bg-white p-4 rounded-lg shadow-lg">
          ...
          <div className="flex flex-row items-center justify-center my-8">
            ...
            <p className="text-9xl font-bold text-dark-green-B">{customersActive}</p>
          </div>
        </div>
        ...
        <div className="basis-1/3 w-full bg-white p-4 rounded-lg shadow-lg">
          ...
          <div className="flex flex-row items-center justify-center my-8">
            ...
            <p className="text-9xl font-bold text-dark-green-B">{servicesAccomplished}</p>
          </div>
        </div>
      ...
      <div className="flex flex-row w-full gap-x-24 px-24">
        ...
        <div className="basis-1/2 w-full bg-white p-4 rounded-lg shadow-lg">
          ...
          <div className="flex flex-row items-center justify-center my-8">
            ...
            <p className="text-9xl font-bold text-dark-green-B">{customersTotal}</p>
          </div>
        ...
        <div className="basis-1/2 w-full bg-white p-4 rounded-lg shadow-lg">
          ...
          <div className="flex flex-row items-center justify-center my-8">
            ...
            <p className="text-9xl font-bold text-dark-green-B">{servicesToday}</p>
          </div>
