      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-dark-green bg-opacity-50 flex flex-col items-center justify-center">
          ...
          <div className="flex space-x-4 text-xl">
            <button className="btn bg-normal-green hover:bg-dark-green text-white h-[56px] w-[202px] rounded">BOOK NOW</button>
            <button className="btn btn-outline border-white hover:bg-transparent hover:text-normal-green text-normal-green h-[56px] w-[202px] rounded">CONTACT US</button>
          </div>
        </div>
      </div>
    </div>
