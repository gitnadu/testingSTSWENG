        ...
        <form className="text-xl relative h-full">
          <div className="mb-8">
            ...
            <input
              data-test="username"
              type="text"
              className={`w-full p-2 text-white bg-transparent placeholder-gray-300 rounded outline-none focus:ring-2 border-[1px] h-[56px]`}
          ...
          <div className="mb-6">
            ...
            <input
              data-test="password"
              type="password"
              className={`w-full p-2 text-white placeholder-gray-300 bg-transparent rounded outline-none focus:ring-2 border-[1px] h-[56px]`}
